...
export default function CodesPage() {
  const faq = faqJsonLd([
    ...
    },
    {
      ...
      answer: "This page keeps a visible check log and is refreshed around game updates, traffic spikes, or credible code claims. The latest check shown here is 2026-07-10."
    },
    {
